...
result_ppl = count_scores(ppl)
result_peeps = count_scores(peeps)

# Print the results
# print("Result for ppl:", result_ppl)
# print("Result for peeps:", result_peeps)
# ====================================================================
...
def adults(people):
    ...
    def adults(people):
    return [person["name"] for person in people if person["age"] >= 21]
...
def tripler(array):
    """Write solution to method and test. Remove pass to start"""
    def tripler(array):
    return [element * 3 for element in array]
